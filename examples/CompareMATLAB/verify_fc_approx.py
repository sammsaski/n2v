...
# For comparison, we'll use approx-star method
reach_method = "approx"
...
try:
    ...
    R_list = net_wrapper.reach(IS, method="approx")
...
# Save the figure
Path('outputs/approx').mkdir(parents=True, exist_ok=True)
plt.savefig("outputs/approx/python_reach_stmnist_plot.png", dpi=150, bbox_inches='tight')
print("Figure saved to: outputs/approx/python_reach_stmnist_plot.png")
plt.close()
...
savemat('outputs/approx/python_verify_fc_results.mat', results)
print("\n✅ Results saved to: outputs/approx/python_verify_fc_results.mat")

# Save detailed text report
with open('outputs/approx/python_verify_fc_results.txt', 'w') as f:
...
print("✅ Results saved to: outputs/approx/python_verify_fc_results.txt")
